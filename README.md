...
It is recommended to use the latest version: TEST [![Version](https://img.shields.io/github/release/jcmturner/gokrb5.svg)](https://github.com/cobraqxx/gokrb5/releases)
